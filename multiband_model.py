...
base_model = sm.Unet(BACKBONE, encoder_weights='imagenet', classes=n_classes, activation='sigmoid', encoder_freeze = True)
...
model_resnet_backbone.save("unet_multiband_bakalauras")
history = history2
